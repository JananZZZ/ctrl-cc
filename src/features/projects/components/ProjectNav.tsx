...
const SC:React.CSSProperties={fontSize:'var(--cc-font-2xs)',fontWeight:400,color:'var(--cc-text-soft)'};
...
const PT:React.CSSProperties={fontSize:'var(--cc-font-2xs)',color:'var(--cc-text-muted)',fontFamily:'var(--cc-font-mono)',whiteSpace:'nowrap',overflow:'hidden',textOverflow:'ellipsis'};
const RB:React.CSSProperties={display:'flex',alignItems:'center',gap:4,flexShrink:0};
const RN:React.CSSProperties={display:'inline-flex',alignItems:'center',justifyContent:'center',minWidth:18,height:18,padding:'0 5px',borderRadius:'var(--cc-radius-full)',background:'var(--cc-green-soft)',color:'var(--cc-green)',fontSize:'var(--cc-font-2xs)',fontWeight:600};
const RK:React.CSSProperties={display:'inline-flex',alignItems:'center',justifyContent:'center',minWidth:18,height:18,padding:'0 5px',borderRadius:'var(--cc-radius-full)',background:'var(--cc-amber-soft)',color:'var(--cc-amber)',fontSize:'var(--cc-font-2xs)',fontWeight:600};
const GC:React.CSSProperties={display:'inline-flex',alignItems:'center',height:18,padding:'0 5px',borderRadius:'var(--cc-radius-xs)',background:'var(--cc-blue-soft)',color:'var(--cc-blue)',fontSize:'var(--cc-font-2xs)',fontWeight:500,fontFamily:'var(--cc-font-mono)',maxWidth:72,overflow:'hidden',textOverflow:'ellipsis',whiteSpace:'nowrap'};
